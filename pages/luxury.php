...
$stmt = $pdo->prepare("SELECT * FROM cars WHERE category = 'luxury' AND availability = 'available'");
$stmt->execute();
...
<head>
  ...
  <title>LUXURY CARS — CARTHA CARS</title>
  ...
  <style>
    *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .btn-test-drive {
      ...
      border: 1px solid rgba(201,168,76,.28); padding: 11px 10px;
      transition: border-color .3s, color .3s, background .3s, transform .2s;
      clip-path: polygon(0 0, calc(100% - 6px) 0, 100% 6px, 100% 100%, 6px 100%, 0 calc(100% - 6px));
    }
    .btn-test-drive:hover { border-color: var(--gold); color: var(--gold); background: rgba(201,168,76,.07); transform: translateY(-1px); }
    ...
    .color-swatch-btn.active .color-circle { border-color: var(--gold); outline-color: var(--gold); }
    ...
    .color-swatch-btn.active .color-swatch-label { color: var(--gold); }

    /* Jantes selectable cards in buy modal */
    .jante-cards-row {
    ...
    .jante-card:hover { border-color: rgba(201,168,76,.32); transform: translateY(-2px); }
    .jante-card.active {
      border-color: var(--gold);
      box-shadow: 0 0 0 1px rgba(201,168,76,.35), 0 0 14px rgba(201,168,76,.14);
    }
    .jante-card-name {
    ...
    .jante-card-price {
      ...
      font-size: 8px; letter-spacing: .1em; color: var(--gold);
    }
    ...
    .btn-buy-send {
      ...
      background: var(--gold); color: #08080b; border: none; padding: 15px;
      transition: background .3s;
      clip-path: polygon(0 0, calc(100% - 9px) 0, 100% 9px, 100% 100%, 9px 100%, 0 calc(100% - 9px));
    }
    .btn-buy-send:hover { background: #dbb85c; }
    ...
    .int-card:hover  { border-color: rgba(201,168,76,.32); transform: translateY(-2px); }
    .int-card.active {
      border-color: var(--gold);
      box-shadow: 0 0 0 1px rgba(201,168,76,.35), 0 0 16px rgba(201,168,76,.16);
    }
    ...
    .int-price-tag {
      display: block; font-family: 'Space Mono', monospace;
      font-size: 8.5px; letter-spacing: .06em; color: var(--gold);
    }
    .cfg-devis {
    ...
    .dv-total-val { font-family: 'Bebas Neue', cursive; font-size: 22px; letter-spacing: .05em; color: var(--gold); }
    .cfg-footer { display: flex; gap: 11px; }
    .btn-cfg-ok {
      flex: 1; font-family: 'Space Mono', monospace; font-size: 9px;
      letter-spacing: .2em; text-transform: uppercase;
      background: var(--gold); color: #08080b; border: none; padding: 13px;
      transition: background .3s;
      clip-path: polygon(0 0, calc(100% - 8px) 0, 100% 8px, 100% 100%, 8px 100%, 0 calc(100% - 8px));
    }
    .btn-cfg-ok:hover { background: #dbb85c; }
    .btn-cfg-cancel {
      font-family: 'Space Mono', monospace; font-size: 9px;
      letter-spacing: .2em; text-transform: uppercase;
    ...
    .td-success {
      ...
      color: var(--gold); letter-spacing: .04em; line-height: 1.7;
    }
    .btn-td-confirm {
      width: 100%; margin-top: 4px;
      font-family: 'Space Mono', monospace; font-size: 10px;
    ...
    .btn-td-confirm:hover { background: #dbb85c; }
    ...
    .btn-contact-send:hover { background: #dbb85c; }
    .contact-success {
      display: none; text-align: center; padding: 32px 0;
      font-family: 'Rajdhani', sans-serif; font-size: 17px;
      color: var(--gold); letter-spacing: .05em;
    ...
    @media (max-width: 900px) {
      ...
      .jante-cards-row { grid-template-columns: 1fr 1fr; }
    }
    @media (max-width: 600px) {
      .cfg-modal-box, .buy-modal-box, .td-modal-box, .partners-modal-box { padding: 28px 20px; }
    ...
    .wiz-step-title {
      font-family: 'Bebas Neue', cursive; font-size: clamp(30px, 5vw, 50px);
    ...
    .wiz-color-btn {
      ...
      background: none; border: none; cursor: pointer; padding: 6px; transition: transform .2s;
    }
    .wiz-color-btn:hover { transform: translateY(-2px); }
    .wiz-color-circle {
      width: 52px; height: 52px; border-radius: 50%;
      border: 2.5px solid transparent; outline: 2px solid rgba(255,255,255,.1);
...
<body>
  ...
  <nav id="mainNav">
    ...
    <ul class="nav-links">
      ...
      <li><a href="luxury.php" class="active" data-nav>LUXURY</a></li>
      <li><a href="standard.php" data-nav>STANDARD</a></li>
  ...
  <section class="hero">
    <div class="hero-bg">
      <img src="https://images.unsplash.com/photo-1563720223185-11003d516935?auto=format&fit=crop&w=1920&q=80" alt="Rolls-Royce Luxury Cars">
    </div>
    <div class="hero-content">
      ...
      <h1 class="hero-title">
        <span class="ht-solid">LUXURY</span>
        <span class="ht-outline">CARS</span>
      </h1>
      <p class="hero-subtitle">Le Raffinement à l'État Pur</p>
    </div>
  ...
  <section class="models-section">
    <div class="section-header fade-up">
      <span class="section-tag">Collection Prestige</span>
      <h2 class="section-title">CHOISISSEZ VOTRE VÉHICULE DE LUXE</h2>
    ...
    <div class="cars-grid">
      ...
      <div class="car-card fade-up">
        <div class="car-img-wrap">
          <img src="https://images.unsplash.com/photo-1624804269473-828dcc30a210?w=800&q=80" alt="Rolls-Royce Ghost" loading="lazy">
          <div class="car-img-overlay"></div>
          <div class="car-tag">Prestige</div>
        </div>
        <div class="car-body">
          <div class="car-name">Rolls-Royce Ghost</div>
          <div class="car-price">8 900 000 DT</div>
          <div class="car-specs">
            <div class="spec-item"><span class="spec-label">Puissance</span><span class="spec-value">571 CH</span></div>
            <div class="spec-item"><span class="spec-label">Places</span><span class="spec-value">5</span></div>
            <div class="spec-item"><span class="spec-label">Trans.</span><span class="spec-value">Auto 8R</span></div>
          </div>
      ...
      <div class="car-card fade-up">
        <div class="car-img-wrap">
          <img src="https://images.unsplash.com/photo-1609679605571-4323e084c314?w=800&q=80" alt="Bentley Continental GT" loading="lazy">
          <div class="car-img-overlay"></div>
          <div class="car-tag">Grand Touring</div>
        </div>
        <div class="car-body">
          <div class="car-name">Bentley Continental GT</div>
          <div class="car-price">6 100 000 DT</div>
          <div class="car-specs">
            <div class="spec-item"><span class="spec-label">Puissance</span><span class="spec-value">635 CH</span></div>
            <div class="spec-item"><span class="spec-label">Places</span><span class="spec-value">4</span></div>
            <div class="spec-item"><span class="spec-label">Trans.</span><span class="spec-value">DCT 8R</span></div>
          </div>
          <div class="car-actions">
            <button class="btn-buy">ACHETER</button>            <button class="btn-test-drive">ESSAI</button>
          </div>
      ...
      <div class="car-card fade-up">
        <div class="car-img-wrap">
          <img src="https://images.unsplash.com/photo-1761668573021-bee02c23b9a8?w=800&q=80" alt="Aston Martin DB11" loading="lazy">
          <div class="car-img-overlay"></div>
          <div class="car-tag">Sport GT</div>
        </div>
        <div class="car-body">
          <div class="car-name">Aston Martin DB11</div>
          <div class="car-price">5 200 000 DT</div>
          <div class="car-specs">
            <div class="spec-item"><span class="spec-label">Puissance</span><span class="spec-value">503 CH</span></div>
            <div class="spec-item"><span class="spec-label">Places</span><span class="spec-value">2+2</span></div>
            <div class="spec-item"><span class="spec-label">Trans.</span><span class="spec-value">ZF 8R</span></div>
          </div>
          <div class="car-actions">
            <button class="btn-buy">ACHETER</button>            <button class="btn-test-drive">ESSAI</button>
          </div>
      ...
      <div class="car-card fade-up">
        <div class="car-img-wrap">
          <img src="https://images.unsplash.com/photo-1559385072-5adb2c4fc83f?w=800&q=80" alt="Lamborghini Urus" loading="lazy">
          <div class="car-img-overlay"></div>
          <div class="car-tag">Super SUV</div>
        </div>
        <div class="car-body">
          <div class="car-name">Lamborghini Urus</div>
          <div class="car-price">5 500 000 DT</div>
          <div class="car-specs">
            <div class="spec-item"><span class="spec-label">Puissance</span><span class="spec-value">650 CH</span></div>
            <div class="spec-item"><span class="spec-label">Places</span><span class="spec-value">5</span></div>
            <div class="spec-item"><span class="spec-label">Trans.</span><span class="spec-value">Auto 8R</span></div>
          </div>
          <div class="car-actions">
      ...
      <div class="car-card fade-up">
        <div class="car-img-wrap">
          <img src="https://images.unsplash.com/photo-1740954694745-327c03107a7d?w=800&q=80" alt="Range Rover SVAutobiography" loading="lazy">
          <div class="car-img-overlay"></div>
          <div class="car-tag">Luxury SUV</div>
        </div>
        <div class="car-body">
          <div class="car-name">Range Rover SVAutobiography</div>
          <div class="car-price">3 100 000 DT</div>
          <div class="car-specs">
            <div class="spec-item"><span class="spec-label">Puissance</span><span class="spec-value">565 CH</span></div>
            <div class="spec-item"><span class="spec-label">Places</span><span class="spec-value">5</span></div>
            <div class="spec-item"><span class="spec-label">Trans.</span><span class="spec-value">Auto 8R</span></div>
          </div>
          <div class="car-actions">
          ...
          <form class="contact-form-grid" id="contactForm" action="contact_process.php" method="POST" onsubmit="submitContact(event)">
            ...
            <div class="cf-full">
              ...
              <select class="cf-select-field" name="voiture">
                ...
                <option>Range Rover SVAutobiography</option>
                <option>Autre</option>
              </select>
            </div>
            <div class="cf-full">
  ...
  <div class="ticker-bar">
    <div class="ticker-label">LUXURY</div>
      ...
      <div class="cfg-select-row">
        <div>
          ...
          <select class="cfg-select" id="selExt">
            <option value="0">Noir Fantôme</option>
            <option value="0">Blanc Arktis</option>
            <option value="3500">Bleu Méditerranée (+3 500 DT)</option>
            <option value="5000">Rouge Carmin (+5 000 DT)</option>
            <option value="8000">Or Sable (+8 000 DT)</option>
          </select>
        </div>
        <div>
          ...
          <select class="cfg-select" id="selIntColor">
            ...
            <option value="0">Beige Crème</option>
            <option value="2000">Bordeaux (+2 000 DT)</option>
            <option value="2000">Cognac (+2 000 DT)</option>
          </select>
        </div>
      </div>
      <div class="cfg-select-row">
        <div>
          <div class="cfg-section-lbl">JANTES</div>
          <select class="cfg-select" id="selRim">
            <option value="0">Standard 20"</option>
            <option value="4000">Sport 21" (+4 000 DT)</option>
            <option value="7000">Forgées 22" (+7 000 DT)</option>
          </select>
        </div>
        <div>
          <div class="cfg-section-lbl">OPTIONS PREMIUM</div>
          <select class="cfg-select" id="selOpt">
            <option value="0">Sans option</option>
            <option value="12000">Pack Driver (+12 000 DT)</option>
            <option value="18000">Pack Confort (+18 000 DT)</option>
            <option value="25000">Pack Signature (+25 000 DT)</option>
          </select>
        </div>
      </div>
      <div class="modal-rule"></div>
  ...
  <div class="modal-overlay" id="tdOverlay">
    <div class="modal-box td-modal-box">
      ...
      <form id="tdForm" action="../reservations/create.php" method="POST" onsubmit="submitTestDrive(event)">
        <input type="hidden" name="source" value="luxury">
  ...
  <script>
    /* ── Ticker ────────────────────────────────── */
    const TICKER_ITEMS = [
      { label: 'Rolls-Royce Ghost',           val: '8 900 000 DT'   },
      { label: 'Bentley Continental GT',      val: '6 100 000 DT'   },
      { label: 'Aston Martin DB11',           val: '5 200 000 DT'   },
      { label: 'Lamborghini Urus',            val: '5 500 000 DT'   },
      { label: 'Range Rover SVAutobiography', val: '3 100 000 DT'   },
      { label: 'Service Conciergerie',        val: '24h / 24'        },
      { label: 'Livraison Premium',           val: 'Tunis & Sfax'    },
      { label: 'Financement Sur Mesure',      val: 'Disponible'      },
      { label: 'Essai Routier Exclusif',      val: 'Sur Rendez-Vous' },
    ];
    ...
    (function () {
      ...
      const CARS = [
        { name:'Rolls-Royce Ghost',           base:8900000, img:'https://images.unsplash.com/photo-1624804269473-828dcc30a210?w=1200&q=80' },
        { name:'Bentley Continental GT',      base:6100000, img:'https://images.unsplash.com/photo-1609679605571-4323e084c314?w=1200&q=80' },
        { name:'Aston Martin DB11',           base:5200000, img:'https://images.unsplash.com/photo-1761668573021-bee02c23b9a8?w=1200&q=80' },
        { name:'Lamborghini Urus',            base:5500000, img:'https://images.unsplash.com/photo-1559385072-5adb2c4fc83f?w=1200&q=80' },
        { name:'Range Rover SVAutobiography', base:3100000, img:'https://images.unsplash.com/photo-1740954694745-327c03107a7d?w=1200&q=80' },
      ];
      const COLORS = [
    ...
    (function () {
      const CARS = [
        { name: 'Rolls-Royce Ghost',           base: 8900000 },
        { name: 'Bentley Continental GT',      base: 6100000 },
        { name: 'Aston Martin DB11',           base: 5200000 },
        { name: 'Lamborghini Urus',            base: 5500000 },
        { name: 'Range Rover SVAutobiography', base: 3100000 },
      ];
      const INTERIORS = [
        { id:'pf', name:'Cuir Pleine Fleur', desc:'Sellerie premium main',              delta:8000,
          sw:'linear-gradient(135deg,#5c3a1e,#8b5a2b 50%,#6b4226)' },
        { id:'np', name:'Cuir Nappa',        desc:'Ultra-doux, finition haute couture', delta:12000,
          sw:'linear-gradient(135deg,#3a2a1a,#6a4a2a 50%,#4a3020)' },
        { id:'al', name:'Alcantara',          desc:'Sport et raffinement',               delta:10000,
          sw:'linear-gradient(135deg,#1c1c22,#2e2e38 50%,#222228)' },
        { id:'bc', name:'Bois et Cuir',      desc:'Combinaison classique',              delta:9000,
          sw:'repeating-linear-gradient(88deg,rgba(160,110,55,.15) 0px,rgba(180,130,65,.1) 2px,transparent 4px),linear-gradient(135deg,#4a3020,#7a5535)' },
        { id:'cc', name:'Carbone et Cuir',   desc:'Style racing luxe',                 delta:15000,
          sw:'repeating-linear-gradient(45deg,rgba(255,255,255,.045) 0,rgba(255,255,255,.045) 3px,transparent 3px,transparent 9px),repeating-linear-gradient(-45deg,rgba(255,255,255,.045) 0,rgba(255,255,255,.045) 3px,transparent 3px,transparent 9px),#101015' },
      ];
      ...
      const selRim   = document.getElementById('selRim');
      const selOpt   = document.getElementById('selOpt');
      ...
      [selExt, selIntC, selRim, selOpt].forEach(s => s.addEventListener('change', refresh));

      function selectorDelta() {
        return [selExt, selIntC, selRim, selOpt].reduce((sum, s) => sum + parseInt(s.value || 0), 0);
      }
      ...
      function openCfg(car) {
        ...
        dvIntRow.style.display = dvDltRow.style.display = 'none';
        [selExt, selIntC, selRim, selOpt].forEach(s => s.selectedIndex = 0);
        intGrid.querySelectorAll('.int-card').forEach(c => c.classList.remove('active'));
    ...
    (function () {
      const NAMES = [
        'Rolls-Royce Ghost', 'Bentley Continental GT', 'Aston Martin DB11',
        'Lamborghini Urus',  'Range Rover SVAutobiography',
      ];
